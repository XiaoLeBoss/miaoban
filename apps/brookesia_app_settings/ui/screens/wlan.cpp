...
#define CELL_ELEMENT_CONF_SW()                                                                                                           \
    {                                                                                                                                    \
        SettingsUI_WidgetCellElement::MAIN | SettingsUI_WidgetCellElement::LEFT_MAIN_LABEL | SettingsUI_WidgetCellElement::RIGHT_SWITCH, \
            SettingsUI_WidgetCellConf {}                                                                                                 \
    }
#define CELL_ELEMENT_CONF_CONNECTED_AP()                                                                                                                                                 \
    {                                                                                                                                                                                    \
        SettingsUI_WidgetCellElement::MAIN | SettingsUI_WidgetCellElement::LEFT_MAIN_LABEL | SettingsUI_WidgetCellElement::LEFT_MINOR_LABEL | SettingsUI_WidgetCellElement::RIGHT_ICONS, \
            SettingsUI_WidgetCellConf {}                                                                                                                                                 \
    }
#define CELL_CONTAINER_MAP()                                                                                                         \
    {                                                                                                                                \
        ...
        {                                                                                                                            \
            ...
            {                                                                                                                        \
                {},                                                                                                                  \
                    {                                                                                                                \
                        {SettingsUI_ScreenWlanCellIndex::PROVISIONING_BLUFI, CELL_ELEMENT_CONF_SW()},                                \
                    },                                                                                                               \
            }                                                                                                                        \
        }                                                                                                                            \
    }
    ...
    SettingsUI_ScreenWlan::SettingsUI_ScreenWlan(App &ui_app, const SettingsUI_ScreenBaseData &base_data,
                                                 const SettingsUI_ScreenWlanData &main_data) : SettingsUI_ScreenBase(ui_app, base_data, SettingsUI_ScreenBaseType::CHILD),
                                                                                               data(main_data)
    {
    }
    // *INDENT-OFF*
    ...
    bool SettingsUI_ScreenWlan::processCellContainerMapUpdate()
    {
        ...
        auto &prov_container_conf = _cell_container_map[SettingsUI_ScreenWlanContainerIndex::PROVISIONING].first;
        prov_container_conf = data.container_confs[(int)SettingsUI_ScreenWlanContainerIndex::PROVISIONING];
        auto &prov_cell_confs = _cell_container_map[SettingsUI_ScreenWlanContainerIndex::PROVISIONING].second;
        {
            int i = static_cast<int>(SettingsUI_ScreenWlanCellIndex::PROVISIONING_BLUFI);
            prov_cell_confs[SettingsUI_ScreenWlanCellIndex::PROVISIONING_BLUFI].second = data.cell_confs[i];
        }
