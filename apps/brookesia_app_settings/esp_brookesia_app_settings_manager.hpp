...
namespace esp_brookesia::apps
{
    ...
    public:
        ...
        void registerAudioResumeCallback(std::function<void()> callback)
        {
            _audio_resume_callback = callback;
        }

    private:
        std::function<void()> _audio_resume_callback;
        ...
        bool processStorageServiceEventSignalUpdateBluFiSwitch(bool is_open);
        ...
        bool processOnUI_ScreenWlanBluFiSwitchChangeEvent(lv_event_t *e);
        ...
        static void onUI_ScreenWlanBluFiSwitchChangeEvent(lv_event_t *e);
        ...
        std::atomic<bool> _is_blufi_sw_flag = false;
        std::atomic<bool> _disable_wlan_scan = false;
